...
module BxBlockBulkUploading
  class AttachmentsController < ApplicationController
    ...
    def create
      attachment = Attachment.find_by(account_id: current_user.id)
      if attachment.present?
        attachment.files.attach(attachments_params[:files])
    ...
    def update
      ...
      if attachment.present?
        ...
        render json: {message: "Attachment does not exist with this account"}, status: :unprocessable_entity
      end
    end
